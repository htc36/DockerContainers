...
assert os.path.exists(
    args.img_path), 'Path to the test image folder does not exist'
...
if __name__ == '__main__':
    ...
    dataset = MiniFlickrDataset(os.path.join(
    ...
    evaluate_dataset(model, test_dataset, args.img_path,
                     save_path, args.temperature)
